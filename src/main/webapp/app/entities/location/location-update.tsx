    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipsterMonolithicReactApp.location.home.createOrEditLabel">
              <Translate contentKey="jhipsterMonolithicReactApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
