  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterMonolithicReactApp.location.delete.question">
          <Translate contentKey="jhipsterMonolithicReactApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
