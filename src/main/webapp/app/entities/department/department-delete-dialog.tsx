  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterMonolithicReactApp.department.delete.question">
          <Translate contentKey="jhipsterMonolithicReactApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
