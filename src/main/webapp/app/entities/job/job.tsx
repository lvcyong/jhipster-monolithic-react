...
export interface IJobState extends IPaginationBaseState {
  search: string;
}
...
export class Job extends React.Component<IJobProps, IJobState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="job-heading">
          <Translate contentKey="jhipsterMonolithicReactApp.job.home.title">Jobs</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jhipsterMonolithicReactApp.job.home.createLabel">Create new Job</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jhipsterMonolithicReactApp.job.home.search')}
                  />
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('jobTitle')}>
                  <Translate contentKey="jhipsterMonolithicReactApp.job.jobTitle">Job Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('minSalary')}>
                  <Translate contentKey="jhipsterMonolithicReactApp.job.minSalary">Min Salary</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('maxSalary')}>
                  <Translate contentKey="jhipsterMonolithicReactApp.job.maxSalary">Max Salary</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="jhipsterMonolithicReactApp.job.employee">Employee</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
