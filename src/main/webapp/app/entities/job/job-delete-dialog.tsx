  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterMonolithicReactApp.job.delete.question">
          <Translate contentKey="jhipsterMonolithicReactApp.job.delete.question" interpolate={{ id: jobEntity.id }}>
