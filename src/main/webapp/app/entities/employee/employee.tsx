    ...
    return (
      <div>
        <h2 id="employee-heading">
          <Translate contentKey="jhipsterMonolithicReactApp.employee.home.title">Employees</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jhipsterMonolithicReactApp.employee.home.createLabel">Create new Employee</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jhipsterMonolithicReactApp.employee.home.search')}
                  />
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('firstName')}>
                    <Translate contentKey="jhipsterMonolithicReactApp.employee.firstName">First Name</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('lastName')}>
                    <Translate contentKey="jhipsterMonolithicReactApp.employee.lastName">Last Name</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('email')}>
                    <Translate contentKey="jhipsterMonolithicReactApp.employee.email">Email</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('phoneNumber')}>
                    <Translate contentKey="jhipsterMonolithicReactApp.employee.phoneNumber">Phone Number</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('hireDate')}>
                    <Translate contentKey="jhipsterMonolithicReactApp.employee.hireDate">Hire Date</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('salary')}>
                    <Translate contentKey="jhipsterMonolithicReactApp.employee.salary">Salary</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('commissionPct')}>
                    <Translate contentKey="jhipsterMonolithicReactApp.employee.commissionPct">Commission Pct</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="jhipsterMonolithicReactApp.employee.department">Department</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="jhipsterMonolithicReactApp.employee.manager">Manager</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
