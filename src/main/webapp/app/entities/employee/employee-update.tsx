    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipsterMonolithicReactApp.employee.home.createOrEditLabel">
              <Translate contentKey="jhipsterMonolithicReactApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : employeeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <UncontrolledTooltip target="firstNameLabel">
                    <Translate contentKey="jhipsterMonolithicReactApp.employee.help.firstName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  <Label id="emailLabel" for="email">
                    <Translate contentKey="jhipsterMonolithicReactApp.employee.email">Email</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label id="salaryLabel" for="salary">
                    <Translate contentKey="jhipsterMonolithicReactApp.employee.salary">Salary</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="manager.id">
                    <Translate contentKey="jhipsterMonolithicReactApp.employee.manager">Manager</Translate>
                  </Label>
