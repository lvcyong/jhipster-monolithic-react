  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterMonolithicReactApp.employee.delete.question">
          <Translate contentKey="jhipsterMonolithicReactApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
