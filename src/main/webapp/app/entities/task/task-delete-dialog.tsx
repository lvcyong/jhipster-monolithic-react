  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterMonolithicReactApp.task.delete.question">
          <Translate contentKey="jhipsterMonolithicReactApp.task.delete.question" interpolate={{ id: taskEntity.id }}>
