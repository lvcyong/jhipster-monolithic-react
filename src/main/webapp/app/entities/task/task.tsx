...
export class Task extends React.Component<ITaskProps, ITaskState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="task-heading">
          <Translate contentKey="jhipsterMonolithicReactApp.task.home.title">Tasks</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jhipsterMonolithicReactApp.task.home.createLabel">Create new Task</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jhipsterMonolithicReactApp.task.home.search')}
                  />
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="jhipsterMonolithicReactApp.task.title">Title</Translate>
                </th>
                <th>
                  <Translate contentKey="jhipsterMonolithicReactApp.task.description">Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
