  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterMonolithicReactApp.country.delete.question">
          <Translate contentKey="jhipsterMonolithicReactApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
