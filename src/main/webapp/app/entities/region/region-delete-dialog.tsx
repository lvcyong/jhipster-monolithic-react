  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterMonolithicReactApp.region.delete.question">
          <Translate contentKey="jhipsterMonolithicReactApp.region.delete.question" interpolate={{ id: regionEntity.id }}>
