    ...
    return (
      <div>
        <h2 id="region-heading">
          <Translate contentKey="jhipsterMonolithicReactApp.region.home.title">Regions</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jhipsterMonolithicReactApp.region.home.createLabel">Create new Region</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jhipsterMonolithicReactApp.region.home.search')}
                  />
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="jhipsterMonolithicReactApp.region.regionName">Region Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
