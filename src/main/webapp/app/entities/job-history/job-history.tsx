    ...
    return (
      <div>
        <h2 id="job-history-heading">
          <Translate contentKey="jhipsterMonolithicReactApp.jobHistory.home.title">Job Histories</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jhipsterMonolithicReactApp.jobHistory.home.createLabel">Create new Job History</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jhipsterMonolithicReactApp.jobHistory.home.search')}
                  />
            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="jhipsterMonolithicReactApp.jobHistory.job">Job</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
              ...
              <tbody>
                {jobHistoryList.map((jobHistory, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <Translate contentKey={`jhipsterMonolithicReactApp.Language.${jobHistory.language}`} />
                    </td>
