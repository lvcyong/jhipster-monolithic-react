  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterMonolithicReactApp.jobHistory.delete.question">
          <Translate contentKey="jhipsterMonolithicReactApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
